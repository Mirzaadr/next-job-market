const ContactPage = () => {
  return (
    <div className="mx-auto max-w-4xl p-6 text-left">
      ...
      <p className="mb-4 text-gray-600">Email: support@jobflow.com</p>
      <p className="mb-4 text-gray-600">Phone: +1 123-456-7890</p>

      <h2 className="mb-2 text-2xl font-semibold">Business Inquiries</h2>
      <p className="mb-4 text-gray-600">Email: business@jobflow.com</p>
      ...
      <p className="mb-4 text-gray-600">Twitter: @JobFlow</p>
      <p className="mb-4 text-gray-600">
